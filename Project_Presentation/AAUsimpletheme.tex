...
\begin{block}{}
  ...
  \begin{columns}
  	\column{0.5\textwidth}
  	\begin{itemize}
  		\item<1-> CVDs are the leading causes of death globally - WHO.
  		\item<2-> Currently used method to check for CVDs is Cardiac Auscultation (CA).
  		\item<3-> CA is a difficult skill to acquire.
  		\item<4-> People are not aware of their heart conditions.
  	\end{itemize}
  	\column{0.5\textwidth}
