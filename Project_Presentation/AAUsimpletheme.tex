...
\pgfdeclareimage[height=1.5cm]{titlepagelogo}{AAUgraphics/EIElogo.png} % placed on the title page
...
\begin{block}{Why the AAU Simple beamer theme?}
  \begin{itemize}
    ...
    \item<3-> Some people (in particular one - Yes, I am looking at you, Mads) have been asking about an AAU beamer theme without a sidebar, and the present theme named \alert{AAU Simple} is an attempt to satisfy this demand. 
