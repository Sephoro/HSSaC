...
Abnormalities occur when there are irregularities in the cycle of S1 and S2, these irregularities are what makes CVDs. As mentioned in section \ref{intro} , the heartbeat audio data is from two sources, a smartphone (Dataset A) and a digital stethoscope (Dataset B). Dataset A has four classes: Normal, Murmur, Extra Heart Sound (HS) and Artifact. Dataset B has has three classes: Normal, Murmur and Extrasystole. 
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale = 0.45]{Final_Report/normal.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale = 0.45]{Final_Report/murmur.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale = 0.45]{Final_Report/extra.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale = 0.45]{Final_Report/extrasys.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale = 0.45]{Final_Report/arti.png}
