...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.6]{./rebuildError_B.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.6]{./rebuildError_A.png}
...
stdWavelet & \begin{tabular}[c]{@{}l@{}}Standard deviation of the approximation \\ of a  $6^{th}$ level db6 DWT of the \\ preprocessed PCG signals.\end{tabular} \\ \hline
